                                    ...
                                    <tbody>
                                        ...
                                        foreach($result as $key){
                                           ...
                                           <td>$<?php echo $key['shipping'];?></td>
                                            ...
                                            <td>
                    <form class="update-status-form" id="updatestat" action="actions/update_status.php" method="post">
...
$(document).ready(function() {
    // Attach the event handler to all forms with class 'update-status-form'
    $('.update-status-form').submit(function(e) {
        e.preventDefault(); // Prevent the default form submission

        var form = new FormData(this); // Create a FormData object from the form

        $.ajax({
            url: "actions/update_status.php", // The URL for the request
            type: 'POST', // HTTP method
            processData: false, // Prevent jQuery from automatically transforming the data into a query string
            contentType: false, // Prevent jQuery from setting the Content-Type header
            dataType: 'json', // The type of data we expect back from the server
            data: form, // The form data to send to the server
