  ...
  <path fill="#000" transform="translate(-31.423 -0.39)" d="M51.151,6.015a5.661,5.661,0,0,1-3.42-1.143A5.662,5.662,0,0,1,45.469.39H41.8V10.414l0,5.49a3.325,3.325,0,1,1-2.281-3.151V9.029a7.218,7.218,0,0,0-1.058-.078,7.034,7.034,0,0,0-5.286,2.364,6.893,6.893,0,0,0,.311,9.505,7.158,7.158,0,0,0,.663.579,7.035,7.035,0,0,0,4.312,1.458,7.219,7.219,0,0,0,1.058-.078,7.011,7.011,0,0,0,3.917-1.959,6.868,6.868,0,0,0,2.06-4.887l-.019-8.2a9.3,9.3,0,0,0,5.688,1.933V6.014h-.011Z" data-name="Path 6566" id="Path_6566"></path>
   ...
   <li>
    ...
    <ul class="menu">
      ...
      <li class="menu__item"><a class="menu__link" href="about-us.php">About</a></li>
      <li class="menu__item"><a class="menu__link" href="shop.php">Shop</a></li>
 
      <li class="menu__item"><a class="menu__link" href="contact.php">Contact</a></li>
    </ul>
    <p>&copy;2024 FatimaDhaini | All Rights Reserved</p>
  </footer>
...
.footer {
  ...
  width: 100%;
  background: #4F6F52;
  min-height: 150px; /* Increase to accommodate mobile views better */
...
.wave {
  position: absolute;
  top: -80px; /* Adjust position for mobile view */
  left: 0;
  width: 100%;
  height: 80px; /* Adjust height for mobile view */
  background: url("https://i.ibb.co/wQZVxxk/wave.png");
  background-size: 1000px 80px; /* Adjust background size for mobile view */
  filter: brightness(1.53) invert(2) sepia(1.2) saturate(1.45) hue-rotate(90deg);
}
...
@media (max-width: 768px) {
  .footer {
    padding: 20px 10px; /* Adjust padding for tablets */
  }
  ...
  .socail-media li a {
    width: 35px; /* Further adjust size for mobile screens */
    height: 35px; /* Further adjust size for mobile screens */
  }

  .socail-media li a svg {
    width: 18px; /* Further adjust size for mobile screens */
    height: 18px; /* Further adjust size for mobile screens */
  }
}

@media (max-width: 480px) {
  .footer {
    padding: 20px 5px; /* Adjust padding for small screens */
  }
  ...
  .socail-media li a {
    width: 30px; /* Adjust size for very small screens */
    height: 30px; /* Adjust size for very small screens */
  }

  .socail-media li a svg {
    width: 16px; /* Adjust size for very small screens */
    height: 16px; /* Adjust size for very small screens */
  }
}
